...
const DEFAULT_COLOR = '#C9A84C'; // Updated to matching Lotus Gold
...
void main() {
  ...
  gl_FragColor  = color;
    ...
    return <div ref={containerRef} className={`light-rays-container ${className}`.trim()} style={{ opacity: opacity }} />;
};
